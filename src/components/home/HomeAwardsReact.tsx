...
const HomeAwardsReact = ({ awards }: { awards: Award[] }) => {
  ...
  useEffect(() => {
    const syncButtons = () => {
      awards.forEach((award, index) => {
        const button = document.querySelector(`button[data-id="circle-${index}"]`)
  ...
  return (
    <section className='w-full h-screen relative overflow-hidden bg-[#121212] text-white'>
      <div className='grid md:grid-cols-2 p-20 relative z-10'>
      ...
      <div className='relative'>
        <div
          id='buttons'
          className='absolute top-0 left-0 z-10 text-black'>
